...
import './App.css';
import * as d3quant from 'd3-quant';
...
function App() {
    ...
    var originalInsert = d3quant.binaryTree.prototype.insert;

    d3quant.binaryTree.prototype.insert = function (node) {
      if (!this.root) {
    ...
    function draw(type, r) {
      ...
      var example = d3.select("#example"),
          width = d3quant.getSize(example.style('width')),
